...
namespace Expense_Tracker.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> AddOrEdit([Bind("Tid,CategoryId,Amount,Note,Date")] Transaction transaction)
        {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Tid,CategoryId,Amount,Note,Date")] Transaction transaction)
        //{
        ...
        //{
        //    return _context.Transactions.Any(e => e.Tid == id);
        //}
    }
}
